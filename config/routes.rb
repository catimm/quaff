Rails.application.routes.draw do
 ...
 resources :beers do
  ...
  get '/users/plan/:id' => 'users#plan', :as => 'user_plan'
  ...
  get 'admin/deliveries/admin_confirm_delivery/:id' => 'admin/deliveries#admin_confirm_delivery', :as =>'admin_confirm_delivery'
