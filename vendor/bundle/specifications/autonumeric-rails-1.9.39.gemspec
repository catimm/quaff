# -*- encoding: utf-8 -*-
# stub: autonumeric-rails 1.9.39 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2015-08-01"
  s.description = "Rails ready-to-use autoNumeric.js library that automatically formats currency and numbers. All credits goes to the library creator BobKnothe".freeze
  s.email = ["randoum@gmail.com".freeze]
  s.homepage = "https://github.com/randoum/autonumeric-rails".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.7.6".freeze
  s.summary = "Wrap autoNumeric.js library ready-to-use for rails".freeze
