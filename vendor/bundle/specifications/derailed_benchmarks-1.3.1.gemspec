# -*- encoding: utf-8 -*-
# stub: derailed_benchmarks 1.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rake>.freeze, ["< 12", "> 10"])
      ...
      s.add_development_dependency(%q<devise>.freeze, ["~> 3"])
    else
      ...
      s.add_dependency(%q<devise>.freeze, ["~> 3"])
    end
  else
    s.add_dependency(%q<heapy>.freeze, ["~> 0"])
    s.add_dependency(%q<memory_profiler>.freeze, ["~> 0"])
