...
$(function() {
	$(".overview-pane").on("mouseover", function(){
		$(this).children(".location-tile-text-row").children(".location-tile-text-div").children(".location-tile-text").css({"text-decoration":"underline"});
	});
	$(".overview-pane").on("mouseout", function(){
		$(this).children(".location-tile-text-row").children(".location-tile-text-div").children(".location-tile-text").css({"text-decoration":"none"});
	});
