module DeliveredDrinkDescriptorCloud
  extend ActiveSupport::Concern

  def delivered_drink_descriptor_cloud(this_drink)
    ...
    @this_drink_all_descriptors = Beer.find_by_id(this_drink.beer.id).descriptors
